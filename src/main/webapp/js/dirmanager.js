(function(){
  var prefxId, prefxClass, isChecked, getSide, flipChecked, initMasterCheck, initMasterFlip, checkedDirs, checkedFiles, checkedFods, addSideClasses, i$, ref$, len$, side;

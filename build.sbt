...
jarName in assembly <<= name(nm => nm + ".jar")
...
libraryDependencies ++= Seq(
  ...
  "org.eclipse.jetty.orbit" % "javax.servlet" % "3.0.0.v201112011016" % "container,compile" artifacts Artifact("javax.servlet", "jar", "jar"),
    // -- these 2 needed to be able to use jetty-env.xml
  "org.eclipse.jetty" % "jetty-plus" % "8.1.7.v20120910" % "container" intransitive(),
  "org.eclipse.jetty" % "jetty-jndi" % "8.1.7.v20120910" % "container" intransitive(),
    // -- testing frameworks --
...
// a standalone server with: java -jar target/appname-lift.jar
